      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="card-glow glass-strong rounded-2xl p-8">
          ...
          <div className="space-y-3">
            <button className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 rounded-lg transition flex items-center justify-center space-x-2 border border-gray-300">
            ...
            <button className="w-full bg-black hover:bg-gray-900 text-white font-semibold py-3 rounded-lg transition flex items-center justify-center space-x-2 border border-gray-800">
